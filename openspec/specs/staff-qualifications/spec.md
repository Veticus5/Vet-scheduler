# staff-qualifications Specification

## Purpose

Named, ordered qualification categories ("tiers") defined separately for each staff group (reception / technicians / doctors), assigned to employees and used as a seniority threshold in scheduling rules. Replaces the former free numeric qualification level.
